        ...
        <div className="home-container" id="home-container">
            <div className="both-header-content">
                <div className="new-home-header">
                    <div class={`cssanimation leMagnify sequence${div1Animation ? "animate":''}`} id={`new${div1Animation ? "animate":''}`}> New </div> <hr id="line" ref={div2Ref}/>
                    <div class={`cssanimation leMagnify sequence${div1Animation ? "animate":''}`} id={`fashion${div1Animation ? "animate":''}`}> Fashion </div>
                </div>
